...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("Advanced", expanded=False):
            ...
            k = st.slider(
                ...
                help="Number of internal candidates to generate. Default k=20 is the evaluated sweet spot."
            )
        ...
        <strong>Pipeline:</strong> Generate 20 candidates &rarr; Score &rarr; Guardrail filter &rarr; MMR Top-3<br><br>
    ...
    with col_results:
        ...
        st.markdown(
            ...
            f'Pipeline: {k if "k" in dir() else 20} candidates &rarr; scored &rarr; '
