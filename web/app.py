...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("Advanced", expanded=False):
            ...
            k = st.slider(
                ...
                help="Number of internal candidates to generate. Default k=30 ensures enough diverse palettes pass the quality filters."
            )
        ...
        <strong>Pipeline:</strong> Generate 30 candidates &rarr; Score &rarr; Guardrail filter &rarr; MMR Top-3<br><br>
    ...
    with col_results:
        ...
        st.markdown(
            ...
            f'Pipeline: {k if "k" in dir() else 30} candidates &rarr; scored &rarr; '
